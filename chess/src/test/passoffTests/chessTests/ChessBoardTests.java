...
public class ChessBoardTests {
    ...
    public void defaultGameBoard() {
        ...
        //check nullity
        ChessPositionImpl pawnPosition = TestFactory.getNewPosition(3, 3);
        ChessPositionImpl knightPosition = TestFactory.getNewPosition(4, 4);
        ChessPositionImpl bishopPosition = TestFactory.getNewPosition(5, 5);
        ChessPositionImpl rookPosition = TestFactory.getNewPosition(6, 6);
